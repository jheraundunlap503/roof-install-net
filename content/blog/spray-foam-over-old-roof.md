---
title: "Can You Spray Foam Over an Old Roof in Arizona? The Honest Answer"
slug: spray-foam-over-old-roof
date: 2026-06-23
published: true
meta_title: "Can You Spray Foam Over an Old Roof in Arizona?"
meta_description: "Foam can go over most existing flat roofs in Arizona — if the substrate is dry and sound. Here's what substrates qualify, when tear-off is required, and how contractors test before spraying."
primary_keyword: spray foam over old roof
keyword_cluster: spray foam over existing roof arizona, can you put foam roof over old roof, SPF over built-up roof, foam over modified bitumen arizona, spray foam roof overlay
type: blog
image_url: https://images.pexels.com/photos/8853538/pexels-photo-8853538.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940
image_alt: construction worker in PPE gear standing on a flat white commercial roof during an inspection
pexels_photo_id: 8853538
---
...
**Existing SPF foam**: A recoat or new foam layer over existing foam is standard practice and the basis of the Arizona foam roof maintenance cycle. See our guide on [foam roofing in Arizona](/blog/foam-roofing-arizona/) for how the recoat schedule works.
...
**1. Moisture in the existing assembly.** This is the non-negotiable. Foam sprayed over a wet substrate traps moisture — which cannot escape through the impermeable foam layer above. Trapped moisture accelerates deck rot, creates a breeding ground for mold, and eventually causes the foam to delaminate. The [National Roofing Contractors Association](https://www.nrca.net/) identifies moisture in the existing assembly as the primary contraindication for any roof overlay, not just foam.
...
The [Spray Polyurethane Foam Alliance](https://www.sprayfoam.org/) recommends moisture testing as a standard pre-application requirement. A contractor who quotes an overlay without conducting or referencing moisture testing has not properly assessed the job.
...
| Scope | Approximate Cost (per sq ft) |
|---|---|
| Foam overlay (no tear-off) | $5.00 – $7.50 installed |
...
Use our [free estimator](/estimator/) to get a baseline replacement cost before comparing overlay vs. tear-off quotes.
...
This is one of the failure modes covered in [what causes roof failure in Arizona](/blog/what-causes-roof-failure-arizona/). Poor installation workmanship — including skipping moisture testing — is a primary driver of premature foam roof failure.
